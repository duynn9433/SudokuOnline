 ...
 * @author duynn
 */
public class RoomInDB222 implements Serializable{
    int test;
    int id;
    int playerID1;
    int playerID2;
    ...
    public RoomInDB222(int id, int playerID1, int playerID2, int winnerID, LocalDateTime startedTime) {
        this.id = id;
    ...
    public RoomInDB222(RoomInDB222 g) {
        this.id = g.id;
